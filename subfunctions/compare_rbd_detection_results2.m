function compare_rbd_detection_results2(EMG_Metric,EMG_est_Yhat_Results,EMG_Yhat_Results,rbd_group,EMG_Table_Names,EMG_feats,label_name,print_figures,print_folder,display_flag)
