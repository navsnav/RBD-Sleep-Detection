function compare_rbd_detection_results3(EMG_Metric,EMG_est_Yhat_Results,EMG_Yhat_Results,ECG_Yhat_Results,rbd_group,EMG_Table_Names,EMG_feats,label_name,print_figures,print_folder,display_flag)
...
[accRBD, sensiRBD, speciRBD, precRBD, recallRBD, f1RBD] = process_classification_results2(ECG_Yhat_Results==1, rbd_group==1);
...
rbd_d_anno_tab = cell2table(rbd_d_anno_data,'VariableNames',{'Accuracy','Sensitivity','Specificity','Precision','Recall','F1','Kappa'},...
    'RowNames',{['MAD (',label_name,')'],['Stream (',label_name,')'],['Atonia Index (',label_name,')'],['Established Metrics (',label_name,')'],['New Features (',label_name,')'],['New ECG Features (',label_name,')']});
