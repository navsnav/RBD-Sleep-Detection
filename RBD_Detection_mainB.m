...
%Matlab Trees
rbd_new_rf_manual_ss = TreeBagger(n_trees,EMG_Table_Pre(:,EMG_feats),EMG_Table_Pre(:,2),'OOBPredictorImportance','on'); 
rbd_est_rf_manual_ss = TreeBagger(n_trees,EMG_Table_Pre(:,EMG_est_feats),EMG_Table_Pre(:,2),'OOBPredictorImportance','on'); 
save('RBD_Detection_RF.mat','rbd_est_rf_manual_ss','rbd_new_rf_manual_ss');
